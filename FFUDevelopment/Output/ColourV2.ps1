function Get-PCInfo {
    ...
    Write-Host " Make:" -BackgroundColor Gray -ForegroundColor White -NoNewLine
    Write-Host "  $manufacturer " -ForegroundColor White -BackgroundColor DarkBlue
    ...
    if ($manufacturer -ne 'Lenovo') {
        ...
        Write-Host " Model:" -BackgroundColor gray -ForegroundColor White -NoNewLine
        ...
        Write-Host " Model:" -BackgroundColor gray -ForegroundColor White -NoNewLine
        Write-Host " $model " -ForegroundColor White -BackgroundColor darkblue

        Write-Host " Machine Type:" -BackgroundColor gray -ForegroundColor White -NoNewLine
        Write-Host " $name " -ForegroundColor White -BackgroundColor darkblue
    }

    Write-Host " Processor:" -BackgroundColor gray -ForegroundColor White -NoNewLine
    Write-Host " $processor " -ForegroundColor White -BackgroundColor blue

    Write-Host " Memory:" -BackgroundColor gray -ForegroundColor White -NoNewLine
